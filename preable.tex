...
\usepackage[T1]{fontenc} % поддержка кирилицы % ещё можно T1 T2B T2A T2
...
\bibliographystyle{gost780} % gost780 - сортировка по порядку следования, gost780s - по алфавиту кажется. gost780u не завелся/ sample